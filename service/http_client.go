...
func newRelayHTTPTransport() *http.Transport {
	...
	// unbounded behaviour.
	transport.ResponseHeaderTimeout = 0 // clear a cloned default when explicitly disabled
...
// GetSSRFProtectedHTTPClient returns the client for fetching arbitrary URLs.
