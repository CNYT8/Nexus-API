...
const maxRedemptionBatchDeleteSize = 100
...
func DeleteRedemptionBatch(c *gin.Context) {
	...
	if len(redemptionBatch.Ids) > maxRedemptionBatchDeleteSize {
		common.ApiErrorI18n(c, i18n.MsgBatchTooMany, map[string]any{"Max": maxRedemptionBatchDeleteSize})
		return
	}
