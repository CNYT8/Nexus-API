...
export const STATIC_I18N_KEYS = [
  ...
  'Previous-day spent quota threshold',
  '0 means no amount limit',
  ...
  'Previous-day spent amount did not meet the check-in requirement',
  ...
  // Advanced Custom model discovery validation
