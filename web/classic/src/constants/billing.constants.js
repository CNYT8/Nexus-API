...
export const BILLING_VARS = [
  ...
  { key: 'c', field: 'outputPrice', tierField: 'output_unit_cost', label: '输出价格', shortLabel: '输出', side: 'output', isBase: true },
  { key: 'len', field: null, tierField: null, label: '输入长度', shortLabel: '长度', side: 'condition', isConditionOnly: true },
  { key: 'cr', field: 'cacheReadPrice', tierField: 'cache_read_unit_cost', label: '缓存命中价格', shortLabel: '缓存命中', side: 'input', group: 'cache' },
  { key: 'cc', field: 'cacheCreatePrice', tierField: 'cache_create_unit_cost', label: '缓存写入价格', shortLabel: '缓存写入', side: 'input', group: 'cache' },
  { key: 'cc1h', field: 'cacheCreate1hPrice', tierField: 'cache_create_1h_unit_cost', label: '1h缓存写入价格', shortLabel: '1h缓存写入', side: 'input', group: 'cache' },
  ...
  { key: 'ao', field: 'audioOutputPrice', tierField: 'audio_output_unit_cost', label: '音频输出价格', shortLabel: '音频输出', side: 'output', group: 'media' },
];
