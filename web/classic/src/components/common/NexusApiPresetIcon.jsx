...
export const isNexusHongKongCloudflarePreset = (color) =>
  color === NEXUS_HK_CLOUDFLARE_PRESET;

const sanitizeId = (id) => String(id).replace(/[^a-zA-Z0-9_-]/g, '');

export default function NexusApiPresetIcon({ size = 24 }) {
  const svgId = sanitizeId(React.useId());
