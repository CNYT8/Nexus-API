            ...
            <Row gutter={16}>
              ...
              <Col xs={24} sm={12} md={8} lg={8} xl={8}>
                <Form.Switch
                  ...
                  extraText={t('开启后将以该设置作为所有用户的默认值')}
                  size='default'
                  checkedText='｜'
                  uncheckedText='〇'
              ...
              <Col xs={24} sm={12} md={8} lg={8} xl={8}>
                <Form.Switch
                  field={'DefaultRecordIpLogForced'}
                  label={t('强制用户使用默认记录请求与错误日志IP设置')}
                  extraText={t('开启后用户不能自行调节记录请求与错误日志IP开关')}
                  size='default'
                  checkedText='｜'
                  uncheckedText='〇'
                  onChange={handleFieldChange('DefaultRecordIpLogForced')}
                />
              </Col>
            </Row>
            <Row gutter={16}>
